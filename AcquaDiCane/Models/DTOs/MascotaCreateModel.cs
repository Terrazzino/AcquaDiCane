...
{
    public class MascotaCreateModel
    {
        ...
        // IMPORTANTE: Necesitas saber a qué cliente pertenece la mascota.
        // No lo estás enviando explícitamente desde el formulario,
        // pero lo puedes obtener del usuario autenticado en el controlador.
        // No lo incluyas en el DTO si lo vas a obtener del token.
        // public int ClienteId { get; set; } // <-- Si lo envías desde el frontend.
    }
}
