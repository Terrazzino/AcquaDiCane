...
namespace AcquaDiCane.Migrations
{
    ...
    [Migration("20250625200040_RefactorizacionDeModelosDatosYAtributos")]
    partial class RefactorizacionDeModelosDatosYAtributos
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AcquaDiCane.Models.Pago", b =>
                {
                    ...
                    b.HasIndex("TurnoId1")
                        .IsUnique()
                        .HasFilter("[TurnoId1] IS NOT NULL");
            ...
            modelBuilder.Entity("AcquaDiCane.Models.Pago", b =>
                {
                    ...
                    b.HasOne("AcquaDiCane.Models.Turno", null)
                        .WithOne("Pago")
                        .HasForeignKey("AcquaDiCane.Models.Pago", "TurnoId1");
